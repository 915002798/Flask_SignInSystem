          ...
          $menus.filter('.am-menu-one').each(function(index) {
            ...
            $navTopItem.on('click', function() {
              ...
              if (prevIndex === undefined) {
                prevIndex = $(this).index0() ? 0 : 1;
              }

              // 判断方向
              var dir = $(this).index0() > prevIndex;
      ...
      (function(global) {
        ...
        PureView.prototype.init = function() {
          ...
          $images.on('click.pureview.amui', function(e) {
            e.preventDefault();
            var clicked = $images.index0(this);
          ...
          this.$navItems.on('click.nav.pureview.amui', function() {
            var index = me.$navItems.index0($(this));
      ...
      (function(global) {
        ...
        Tabs.prototype.open = function($nav) {
          ...
          var $target = regexHash.test(href) && this.$content.find(href) ||
            this.$tabPanels.eq($navs.index0($nav));
        ...
        Tabs.prototype.getNextNav = function($panel) {
          var navIndex = this.$tabPanels.index0($panel);
          var rightSpring = 'am-animation-right-spring';
